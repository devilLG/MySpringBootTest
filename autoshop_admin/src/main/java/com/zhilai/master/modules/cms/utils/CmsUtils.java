 ...
 */
package com.zhilai.master.modules.cms.utils;
...
public class CmsUtils {
    ...
    public static String getUrlDynamic(Article article) {
        ...
        str.append("/view-").append(article.getCategory().getLogid()).append("-").append(article.getLogid()).append(Global.getUrlSuffix());
        return str.toString();
    }
    ...
    public static String getUrlDynamic(Category category) {
        ...
        StringBuilder str = new StringBuilder();
        str.append(context.getContextPath()).append(Global.getFrontPath());
        str.append("/list-").append(category.getLogid()).append(Global.getUrlSuffix());
        return str.toString();
    }
