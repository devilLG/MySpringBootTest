 ...
 */
package com.zhilai.master.modules.gen.service;
...
import com.zhilai.master.modules.gen.dao.GenSchemeDao;
import com.zhilai.master.modules.gen.dao.GenTableColumnDao;
import com.zhilai.master.modules.gen.dao.GenTableDao;
import com.zhilai.master.modules.gen.entity.GenConfig;
...
import com.zhilai.master.modules.gen.entity.GenTemplate;
import com.zhilai.master.modules.gen.util.GenUtils;
...
//	private GenTemplateDao genTemplateDao;
	...
	public String save(GenScheme genScheme) {
		if (StringUtils.isBlank(genScheme.getLogid())){
			genScheme.preInsert();
	...
	private String generateCode(GenScheme genScheme){
		...
		// 查询主表及字段列
		GenTable genTable = genTableDao.get(genScheme.getGenTable().getLogid());
		genTable.setColumnList(genTableColumnDao.findList(new GenTableColumn(new GenTable(genTable.getLogid()))));
		...
		for (GenTable childTable : genTable.getChildList()){
			...
			childTable.setColumnList(genTableColumnDao.findList(new GenTableColumn(new GenTable(childTable.getLogid()))));
