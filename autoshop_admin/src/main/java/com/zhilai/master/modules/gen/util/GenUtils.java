 ...
 */
package com.zhilai.master.modules.gen.util;
...
import com.zhilai.master.common.mapper.JaxbMapper;
import com.zhilai.master.common.utils.DateUtils;
import com.zhilai.master.common.utils.FileUtils;
import com.zhilai.master.common.utils.FreeMarkers;
import com.zhilai.master.common.utils.StringUtils;
import com.zhilai.master.modules.gen.entity.GenCategory;
...
public class GenUtils {
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			// 如果是不是新增列，则跳过。
			if (StringUtils.isNotBlank(column.getLogid())){
				continue;
			}
			...
			// 父级ID
				...
				column.setJavaField("parent.logid|name");
