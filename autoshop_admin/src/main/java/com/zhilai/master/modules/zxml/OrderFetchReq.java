...
public class OrderFetchReq extends ClientReqHead {
	private final static Log log = LogFactory.getLog(OrderFetchReq.class);
	...
	public String CreateXml() {
		try {
			...
			JSONbox.put("FetchType", orderApply.getFetch_type()+"");
