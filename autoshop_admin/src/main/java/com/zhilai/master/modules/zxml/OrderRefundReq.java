...
public class OrderRefundReq extends ClientReqHead {
	private final static Log log = LogFactory.getLog(OrderRefundReq.class);
	...
	public String CreateXml() {
		try {
			...
			JSONbox.put("PayState", orderApply.getPay_state()+"");
