...
public class GetPayCodeReq extends ClientReqHead {
	private final static Log log = LogFactory.getLog(GetPayCodeReq.class);
	...
	public String CreateXml() {
		try {
			...
			JSONbox.put("TotalFee", orderApply.getSale_total()+"");
			JSONbox.put("OrderTime", DateUtil.getNow());
