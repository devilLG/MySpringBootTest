...
public class OrderAbnormalReq extends ClientReqHead {
	private final static Log log = LogFactory.getLog(OrderAbnormalReq.class);
	...
	public String CreateXml() {
		try {
			...
			JSONbox.put("CurState", orderApply.getAbnormal_type()+"");
