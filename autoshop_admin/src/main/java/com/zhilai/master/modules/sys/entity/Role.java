 ...
 public List<String> getMenuIdList() {
	...
	public void setMenuIdList(List<String> menuIdList) {
		...
		for (String menuId : menuIdList) {
			Menu menu = new Menu();
			menu.setLogid(menuId);
			menuList.add(menu);
		}
	}
	
	public List<Menu> getMenuIdLists() {
		return menuList;
	}
	
	public void setMenuIdLists(List<Menu> menuIdList) {
		menuList = Lists.newArrayList();
	...
	public List<String> getOfficeIdList() {
		...
		for (Office office : officeList) {
			officeIdList.add(office.getLogid());
		}
		return officeIdList;
	}
