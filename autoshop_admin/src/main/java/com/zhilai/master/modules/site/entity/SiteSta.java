 ...
 * 
 */
public class SiteSta extends DataEntity<SiteSta> {
	...
	@ExcelField(title="货道总数", sort=16)
	public int getBox_all() {
		return box_all;
	}
	@ExcelField(title="货道空箱数量", sort=17)
	public int getBox_empty() {
		return box_empty;
	}
	@ExcelField(title="货道缺货数量", sort=18)
	public int getBox_short() {
		return box_short;
	}
	@ExcelField(title="当前故障数量", sort=19)
