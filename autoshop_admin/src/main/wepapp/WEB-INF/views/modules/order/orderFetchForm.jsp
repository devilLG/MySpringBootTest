...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orderApply/fetchForm">取货【${orderApply.order_id}】</a></li>
	</ul><br/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#main" data-toggle="tab">订单信息</a></li>
		<li><a href="#sub" data-toggle="tab"><span>商品信息</span></a></li>
	</ul><br/>
	<form:form id="orderFetchForm" modelAttribute="orderApply" action="${ctx}/order/orderApply/fetch" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">取货类型:</label>
			<div class="controls">
				<form:select path="fetch_type" class="input-small required">
					<form:option value="" label="请选择"/>
					<form:options items="${fns:getDictList('fetch_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
		...
		<div class="form-actions">
		    <input id="btnSubmit" class="btn btn-primary" type="submit" value="取货"/>
