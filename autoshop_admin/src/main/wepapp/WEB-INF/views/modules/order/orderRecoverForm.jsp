...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orderApply/recoverForm">回收【${orderApply.order_id}】</a></li>
	</ul><br/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#main" data-toggle="tab">订单信息</a></li>
		<li><a href="#sub" data-toggle="tab"><span>商品信息</span></a></li>
	</ul><br/>
	<form:form id="orderRecoverForm" modelAttribute="orderApply" action="${ctx}/order/orderApply/recover" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">回收人:</label>
			<div class="controls">
				 <sys:treeselect id="user" name="login_id" value="" labelName="login_name" labelValue=""
		...
		<div class="form-actions">
		    <input id="btnSubmit" class="btn btn-primary" type="submit" value="回收"/>
