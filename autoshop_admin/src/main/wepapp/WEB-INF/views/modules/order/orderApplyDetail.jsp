...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orderApply/detail">详情【${orderApply.order_id}】</a></li>
	</ul><br/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#main" data-toggle="tab">订单信息</a></li>
		<li><a href="#sub" data-toggle="tab"><span>商品信息</span></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="orderApply" action="${ctx}/order/orderApply/detail" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="abnormalType" class="input-medium" disabled="true">
					<form:option value="" label="无"/>
					<form:options items="${fns:getDictList('order_abnormal_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="order_type" class="input-medium" disabled="true">
					<form:option value="" label="请选择"/>
