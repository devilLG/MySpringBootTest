...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orderApply/cancelForm">取消【${orderApply.order_id}】</a></li>
	</ul><br/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#main" data-toggle="tab">订单信息</a></li>
		<li><a href="#sub" data-toggle="tab"><span>商品信息</span></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="orderApply" action="${ctx}/order/orderApply/cancel" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-warning" type="submit" value="取消"/>
