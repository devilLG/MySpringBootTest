...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			<!--header-->
       		<%@ include file="/WEB-INF/views/modules/pages/include/header.jsp" %>
				...
				<section class="content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box">
								<div class="box-body">
									<table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" style="align:center">
										<thead>
											<tr class="info">
		...
		<script src="<%=path%>/zzw/js/app.js"></script>
	</body>
</html>
