...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/notice/noticeTemplate/">公共通知模板列表</a></li>
		<li class="active"><a href="${ctx}/notice/noticeTemplate/form?logid=${noticeTemplate.logid}">公共通知模板${not empty noticeTemplate.logid?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="noticeTemplateForm" modelAttribute="noticeTemplate" action="${ctx}/notice/noticeTemplate/save" method="post" class="form-horizontal">
		...
		<div class="tab-content">
			...
			<div class="span6">
				...
				<c:if test="${noticeTemplate.main_type eq '01'}">
					<div  class="control-group">
				...
				<c:if test="${noticeTemplate.main_type eq '02'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '03'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '04'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '05'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '06'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv"  class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '07'}">
					<div class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv"  class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '08'}">
					<div  class="control-group">
						<label class="control-label">模板小类:</label>
						<div id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
				...
				<c:if test="${noticeTemplate.main_type eq '09'}">
					<div class="control-group">
						<label class="control-label">模板小类:</label>
						<div  id="subTypeDiv" class="controls">
							<form:select path="sub_type" class="input-large">
...
function typeChange (e) {
	...
	$.ajax({
		type:"POST",
		url:"${ctx}/notice/noticeTemplate/typeChange",
		data:{'type':type},
		async: false,
		dataType: "json",
	 ...
	 top.$.jBox.open("iframe:${ctx}/notice/noticeField/showTemplate", "选择字段", 500, 300, {
		...
		submit:function(v, h, f){
			if (v=="ok"){
				...
				var tem = $("#noticeTemplateForm textarea[name='content']").val();
				if(parms){
					tem = tem+"\${"+parms.split(",")[0]+"}";
					$("#noticeTemplateForm textarea[name='content']").val(tem);
				}						
			}
		}, 
		loaded:function(h){
