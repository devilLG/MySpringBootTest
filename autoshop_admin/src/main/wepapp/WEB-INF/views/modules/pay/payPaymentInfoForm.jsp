...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pay/payPaymentInfo/">支付平台账单列表</a></li>
		<li class="active"><a href="${ctx}/pay/payPaymentInfo/form?trade_number=${payPaymentInfo.trade_number}">支付平台账单详情</a></li>
	</ul><br/>
	<form:form id="payPaymentInfoForm" modelAttribute="payPaymentInfo" action="${ctx}/pay/payPaymentInfo/save" method="post" class="form-horizontal">
		...
		<div class="tab-content">
			...
			<div class="span6">
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="pay_id" htmlEscape="false" readonly="true" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">对账金额:</label>
					<div class="controls">
						<form:input path="fee_sum" htmlEscape="false" readonly="true" />
					</div>
				</div>
				<div class="control-group">
