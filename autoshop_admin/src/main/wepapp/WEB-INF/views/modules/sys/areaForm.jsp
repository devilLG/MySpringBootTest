...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="form?id=${area.logid}&parent.logid=${area.parent.logid}">区域<shiro:hasPermission name="sys:area:edit">${not empty area.logid?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:area:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="parent.logid" value="${area.parent.logid}" labelName="parent.name" labelValue="${area.parent.name}"
					title="区域" url="/sys/area/treeData" extId="${area.logid}" cssClass="" allowClear="true"/>
			</div>
		</div>
		<div class="control-group">
