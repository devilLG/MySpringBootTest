...
<body >
	<div style="padding-top:10%;margin-left: 5%;">
		&nbsp;&nbsp;&nbsp;流量阈值:&nbsp;<input id="warValue" name="warValue" style="width: 100px;" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " htmlEscape="false" maxlength="5"/>&nbsp;MB/天
	</div>
