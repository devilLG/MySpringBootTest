...
//周验证
jQuery.validator.addMethod("week_v", function(value, element) {
    return this.optional(element) || ( value >= 1 && value <= 7 );
}, "请正确填写周期指");

//月验证
jQuery.validator.addMethod("month_v", function(value, element) {
	return this.optional(element) || ( value >= 1 && value <= 30 );
}, "请正确填写周期指");
